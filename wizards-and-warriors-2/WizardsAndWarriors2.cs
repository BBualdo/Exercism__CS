static class GameMaster
{
    ...
    public static string Describe(TravelMethod travelMethod = TravelMethod.Walking) => $"You're traveling to your destination {(travelMethod == TravelMethod.Horseback ? "on horseback" : "by walking")}.";
